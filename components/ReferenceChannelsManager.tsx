...
import { ReferenceChannel, ViralScriptRef, ThumbnailRef } from '@/lib/types/referenceChannels';
...
export default function ReferenceChannelsManager({ channels = [], onChange }: ReferenceChannelsManagerProps) {
  ...
  // Modal / Form state para novo canal
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-emerald-950/30 border border-emerald-800/40 rounded-xl p-4 flex items-start space-x-3 text-sm text-emerald-200">
        ...
        <div>
          <h4 className="font-semibold text-emerald-300">Canais de Referência & Benchmarks do Projeto</h4>
          <p className="text-emerald-400/80 text-xs mt-1 leading-relaxed">
            Cadastre os canais de referência do seu nicho, roteiros virais e thumbnails de sucesso. 
            Estes ativos alimentarão automaticamente o <strong>ScriptEngine</strong> (clonagem de DNA de retenção) 
            e o <strong>ProductionAssembler</strong> (geração de prompts de thumbnails A/B).
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-zinc-800 pb-3">
        ...
        >
          ...
          <span>Novo Canal de Referência</span>
        </button>
      </div>
      ...
      {activeChannel ? (
        ...
        <div className="text-center py-12 border border-dashed border-zinc-800 rounded-xl bg-zinc-950/40">
          ...
          <p className="text-sm font-medium text-zinc-300">Nenhum canal de referência selecionado.</p>
